...
export default function Convenio_Prueba() {
    ...
    return (
        <div className="py-10 px-4">
            <h1 className="text-4xl font-bold text-center">CONVENIO DE TRANSFERENCIA A PRUEBA</h1>
            ...
            >
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-6">
                            <h4 className="font-bold text-lg text-center"> PLAZO HASTA 
                            ...
                            <div>
                                <label htmlFor="date_option" className="block text-sm font-medium text-cyan-950">
                                </label>
                                <input
                                    id="date_option"
                                    type="text"
                                ...
                                />
                                {errors.date_option && <p className="text-red-500 py-1 text-xs">{errors.date_option.message}</p>}
                            </div>
