...
export default function Convenio_Prueba() {
  const [selectedLigaCheckbox, setSelectedLigaCheckbox] = useState<
    string | null
  >(null);
  const [selectedDirigidoCheckbox, setSelectedDirigidoCheckbox] = useState<
    string | null
  >(null);
  ...
  function handleDirigidoCheckboxSelection(e: ChangeEvent<HTMLInputElement>) {
    const value = e.target.value;
    setSelectedDirigidoCheckbox(
      value === selectedDirigidoCheckbox ? null : value
    );
  }
  ...
  return (
    <div className="py-10 px-4">
      <h1 className="text-4xl font-bold text-center">
        CONVENIO DE TRANSFERENCIA A PRUEBA
      </h1>
      ...
      >
          ...
          {selectedDirigidoCheckbox === "Liga" && (
            <div className="space-y-4">
              <div>
                ...
                />
                {errors.dirigido_hacia && (
                  <p className="text-red-500 py-1 text-xs">
                    {errors.dirigido_hacia.message}
                  </p>
                )}
              </div>
            </div>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            />
            {errors.presidente_cedente && (
              <p className="text-red-500 py-1 text-xs">
                {errors.presidente_cedente.message}
              </p>
            )}
          </div>
          ...
          <div>
            ...
            <input
              ...
              {...register("presidente_cedente")}
            />
            {errors.secretario_cedente && (
              <p className="text-red-500 py-1 text-xs">
                {errors.secretario_cedente.message}
              </p>
            )}
          </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              />
              {errors.presidente_cesionario && (
                <p className="text-red-500 py-1 text-xs">
                  {errors.presidente_cesionario.message}
                </p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errors.secretario_cesionario && (
                <p className="text-red-500 py-1 text-xs">
                  {errors.secretario_cesionario.message}
                </p>
              )}
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  />
                  {errors.clausulas_anexadas && (
                    <p className="text-red-500 py-1 text-xs">
                      {errors.clausulas_anexadas.message}
                    </p>
                  )}
                  <div className="text-center text-xs py-2">
                    Por favor, recuerde seleccionar la opción doble-faz de su
                    impresora.
                  </div>
                </div>
              </div>
