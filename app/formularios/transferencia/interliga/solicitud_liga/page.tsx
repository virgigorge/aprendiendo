...
export default function Solicitud_Liga() {
  const [selectedLigaCheckbox, setSelectedLigaCheckbox] = useState<
    string | null
  >(null);
  const [selectedTutorCheckbox, setSelectedTutorCheckbox] = useState<
    string | null
  >(null);
