...
export default function Ficha_Comun() {
  ...
  return (
    <div className="items-center py-10 px-4">
            ...
            <h1 className="text-4xl font-bold text-center"> SOLICITUD DE INSCRIPCIÓN </h1>
          ...
          >
            ...
            <div className="space-y-4">
              <h4 className="font-bold text-lg text-center mb-4">QUIEN SUSCRIBE:</h4>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                {errors.division && <p className="text-red-500 py-1 text-xs">{errors.division.message}</p>}
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h4 className="font-bold text-lg text-center mb-4 py-1">
                AUTORIZACIÓN: <small className="font-light text-xs">(SÓLO SI ES MENOR DE EDAD)</small>
              </h4>

              {[
                "Padre", "Madre", "Tutor"].map((role) => (
                <label key={role} className="flex items-center gap-10 mb-3 cursor-pointer">
                  <input
                    type="checkbox"
                    name="tutor"
                    value={role}
              ...
              {["tutor_name", "tutor_dni"].map((id, index) => (
                <div key={id}>
                  ...
                  {errors[id as keyof FormData] && (
                    <p className="text-red-500 py-1 text-xs">{errors[id as keyof FormData]?.message}</p>
                  )}
                </div>
              ))}
            </div>
